...
from aiogram.types import FSInputFile, BusinessMessage, Message # Добавлен BusinessMessage
...
async def handle_start_business(message: BusinessMessage): # Использовать BusinessMessage
...
async def handle_text_to_text(message: BusinessMessage): # Использовать BusinessMessage
    
...
async def handle_voice_to_voice(message: BusinessMessage): # Использовать BusinessMessage
    
    business_id = message.business_connection_id
    if not business_id or not message.chat.id:
...
async def handle_unhandled_business_messages(message: BusinessMessage): # Использовать BusinessMessage
